  ...
  return (
    <>
      ...
      <main className="z-10 file:w-screen h-screen flex flex-col px-[20%] desktop:px-[30%] ">
        <br></br>
        <div className="animate-fade backdrop-filter backdrop-blur-lg border-2 border-base-200 dark:border-stone-950 bg-stone-100 dark:bg-stone-950 bg-opacity-30 dark:bg-opacity-30 rounded-box p-4">
          ...
          <p className="animate-fade animate-duration-1000 animate-delay-[2000ms] animate-once">
            ...
            member of Cohort 16 and I&apos;m getting ready for my first role in
            the industry.
          </p>
          <br></br>
          <br></br>
          <p className="animate-fade animate-duration-1000 animate-delay-[3000ms] animate-once">
